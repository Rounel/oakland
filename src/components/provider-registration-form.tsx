        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <div className="border-2 border-dashed flex items-center border-gray-300 dark:border-gray-700 rounded-lg p-1 text-center gap-4">
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <div className="flex gap-2">
                      ...
                      />
                      <FormControl>
                        <Input placeholder="6 12 34 56 78" {...field} className="flex-1" />
                      </FormControl>
                    </div>
                    <FormMessage />
                  </FormItem>
          ...
          {step === 3 && (
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Conditions générales</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-6">
